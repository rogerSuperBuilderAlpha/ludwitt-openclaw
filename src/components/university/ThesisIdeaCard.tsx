...
import type { UniversityThesisIdeaDisplay } from '@/lib/types/university'

interface ThesisIdeaCardProps {
  idea: UniversityThesisIdeaDisplay
  onClick: () => void
}

export function ThesisIdeaCard({ idea, onClick }: ThesisIdeaCardProps) {
    ...
    >
      <div className="flex items-start justify-between mb-1.5">
        <div className="flex items-center gap-2.5">
          <Article size={18} weight="duotone" className="text-gray-500 shrink-0" />
