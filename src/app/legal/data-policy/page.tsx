    ...
    <article className="bg-white rounded-lg border border-gray-200 shadow-sm p-8 sm:p-12">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed">
          This Data Policy explains how Ludwitt handles the data generated
          through your use of our adaptive learning platform. It covers learning
          data, third-party data sharing, data retention, and your rights. This
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-3">
          When you use Ludwitt, we collect learning data to power the adaptive
          experience:
        </p>
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
          <li>
            <strong>Performance Data:</strong> Answers submitted, correctness,
            time spent, difficulty levels, and skill assessments.
          </li>
          <li>
            <strong>Progress Data:</strong> XP earned, streaks, achievements
            unlocked, and levels completed.
          </li>
          <li>
            <strong>Interaction Data:</strong> Hints requested, explanations
            viewed, AI tutoring conversations, and study room participation.
          </li>
          <li>
            <strong>Preference Data:</strong> Subject selections, display
            settings, and notification preferences.
          </li>
        </ul>
        <p className="text-gray-700 leading-relaxed mt-3">
          This data is used exclusively to personalize your learning experience,
          adjust difficulty, and track your progress. It is never used for
          advertising.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-3">
          We share data with third parties only as necessary to operate the
          Platform:
        </p>
        ...
        <p className="text-gray-700 leading-relaxed mt-3">
          Content sent to Anthropic for AI processing is not used for training
          AI models. We do not sell, rent, or trade your data to any third
          party.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <li>
            <strong>Deleted accounts:</strong> Personal data is deleted or
            anonymized within 30 days of account deletion.
          </li>
          <li>
            <strong>Inactive accounts:</strong> Accounts inactive for 2+ years
            may be purged after notification.
          </li>
          <li>
            <strong>Anonymized data:</strong> Aggregated, de-identified learning
            analytics may be retained indefinitely for research and platform
            improvement.
          </li>
          <li>
            <strong>Legal obligations:</strong> Some data may be retained longer
            if required by law.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed">
          You can request an export of your data at any time by contacting us at{' '}
          <a
          ...
          . We will provide your data in a machine-readable format (JSON) within
          30 days.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed">
          ...
          and audited. We conduct regular security reviews and follow industry
          best practices.
        </p>
      </section>
