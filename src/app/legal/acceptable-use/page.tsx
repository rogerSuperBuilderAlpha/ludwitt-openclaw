    ...
    <article className="bg-white rounded-lg border border-gray-200 shadow-sm p-8 sm:p-12">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed">
          This Acceptable Use Policy outlines the rules for using the Ludwitt
          learning platform. It exists to ensure a safe, productive, and
          respectful environment for all learners. Violations may result in
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <li>
            Harass, bully, or threaten other users in messages, study rooms, or
            cohorts.
          </li>
          ...
          <li>
            Use the Platform for any commercial purpose other than personal
            learning.
          </li>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-3">
          When using AI-powered features (tutoring, explanations, problem
          generation), you agree to:
        </p>
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
          <li>Use AI features for legitimate educational purposes only.</li>
          <li>
            Not attempt to manipulate AI responses for non-educational content
            generation.
          </li>
          <li>
            Not submit prompts designed to extract harmful, offensive, or
            inappropriate content.
          </li>
          <li>
            Report any AI responses that seem incorrect, inappropriate, or
            concerning.
          </li>
          <li>
            Understand that AI-generated content is for learning assistance and
            may contain errors.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <li>
            Do not record or share video/audio from study rooms without consent
            from all participants.
          </li>
          <li>
            Report any inappropriate behavior to the cohort mentor or support
            team.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
          <li>
            <strong>Warning:</strong> A notification about the violation and
            expected corrective action.
          </li>
          <li>
            <strong>Temporary suspension:</strong> Restricted access to specific
            features or the entire Platform.
          </li>
          <li>
            <strong>Permanent termination:</strong> Deletion of the account for
            severe or repeated violations.
          </li>
        </ul>
        <p className="text-gray-700 leading-relaxed mt-3">
          We will review all reports fairly and provide an opportunity to appeal
          decisions.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700 leading-relaxed">
          If you encounter a violation of this policy, please report it to{' '}
          <a
