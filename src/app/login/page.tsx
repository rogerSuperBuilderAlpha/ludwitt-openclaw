...
import { useLoginAuth } from '@/lib/useLoginAuth'
...
const INPUT_BASE =
  'w-full pl-12 py-3.5 bg-gray-50 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent'
const INPUT_CLASS = INPUT_BASE + ' pr-4'
const INPUT_CLASS_PW = INPUT_BASE + ' pr-12'
const SUBMIT_CLASS =
  'w-full py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-white font-semibold rounded-xl hover:from-amber-400 hover:to-amber-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-amber-500/25'
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (showResetConfirmation) clearResetConfirmation()
                      }}
                      className={INPUT_CLASS}
              ...
              {mode === 'signup' && (
                <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-xl">
                  <p className="text-sm text-amber-700">
                    <strong className="text-amber-800">Age Requirement:</strong>{' '}
                    Children under 13 require parental consent to register per
                    COPPA regulations.
                  </p>
                </div>
              )}
